...
const ships = [
  ...
  [
    { position: { x: 2, y: 1 }, direction: true, type: 'huge', length: 4 },
    { position: { x: 5, y: 6 }, direction: false, type: 'large', length: 3 },
  ...
  [
    ...
    { position: { x: 7, y: 1 }, direction: false, type: 'medium', length: 2 },
  ...
  [
    ...
    { position: { x: 8, y: 8 }, direction: true, type: 'medium', length: 2 },
  ...
  [
    ...
    { position: { x: 1, y: 3 }, direction: true, type: 'large', length: 3 },
    ...
    { position: { x: 5, y: 6 }, direction: true, type: 'small', length: 1 },
  ],
  [
    { position: { x: 3, y: 1 }, direction: true, type: 'huge', length: 4 },
    { position: { x: 5, y: 0 }, direction: false, type: 'large', length: 3 },
